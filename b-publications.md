...
<br> <span style="font-size:14px">  **Mingzhang Yin**, Ziwei Cong, Jia Liu  <br> Marketing Science, 2025.

Modeling Dynamic Consumer Preferences from Few-shot Data: A Meta-Learning Approach
<br> <span style="font-size:14px">  **Mingzhang Yin**, Khaled Boughanmi, Anirban Mukherjee  <br> Journal of Marketing Research (JMR), 2026.
...
<br> <span style="font-size:14px">  Yang Zhao, Yixin Wang, **Mingzhang Yin** <br> Empirical Methods in Natural Language Processing (EMNLP), 2025.
...
Probabilistic Machine Learning: New Frontiers for Modeling Consumers and their Choices <br> <span style="font-size:14px">  Ryan Dew, Nicolas Padilla, et al., and **Mingzhang Yin**.  <br> International Journal of Research in Marketing (IJRM)
...
<br> <span style="font-size:14px">  Choudur Lakshminarayan, **Mingzhang Yin** <br> Applied Stochastic Models in Business and Industry, 2020.
...
<br> <span style="font-size:14px">  Alain Lemaire\*, **Mingzhang Yin\***, Oded Netzer  <br> SSRN. [pdf](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5205681)

Probabilistic Best Subset Selection via Gradient-Based Optimization
<br> <span style="font-size:14px">  **Mingzhang Yin**, Nhat Ho, Bowei Yan, Xiaoning Qian, Mingyuan Zhou  <br> arXiv 2006.06448. [pdf](https://arxiv.org/pdf/2006.06448.pdf), [code](https://github.com/mingzhang-yin/Probabilistic-Best-Subset)

Bayesian Invariance Modeling of Multi-Environment Data
<br> <span style="font-size:14px">  Luhuan Wu, **Mingzhang Yin**, Yixin Wang, John Patrick Cunningham, David Blei  <br> arXiv 2506.22675. [pdf](https://arxiv.org/pdf/2506.22675.pdf)

Relaxation of Projected Prior with Continuous Gap Shrinkage
<br> <span style="font-size:14px">  Leo L Duan, Sunghyun Cho, **Mingzhang Yin**  <br> arXiv 2605.14936. [pdf](https://arxiv.org/pdf/2605.14936.pdf)
